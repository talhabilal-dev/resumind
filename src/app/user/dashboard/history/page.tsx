    ...
    <>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-foreground/65">
              View processing history as metadata only. No resume files are
              exposed here.
            </p>
          </div>
        </div>
      ...
      <main className="space-y-6 p-4 sm:p-6">
        ...
        <section className="rounded-xl glow-card bg-white/5 p-5 sm:p-6">
          ...
          <p className="text-sm text-foreground/65">
            Includes job target, workflow, credits used, score and status. No
            file downloads.
          </p>
          ...
          <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-3">
            <label className="relative block">
              ...
              <input
                ...
                className="w-full rounded-md border border-rose-500/20 bg-zinc-900 py-2 pl-9 pr-3 text-sm text-foreground placeholder:text-foreground/50 focus:border-rose-500/50 focus:outline-none"
              />
            </label>
            ...
            <select
              ...
              className="rounded-md border border-rose-500/20 bg-zinc-900 px-3 py-2 text-sm text-foreground focus:border-rose-500/50 focus:outline-none"
            >
          ...
          {!loading && historyData.length > 0 ? (
            <div className="mt-4 flex items-center justify-between gap-3">
              <p className="text-xs text-foreground/60">
                Showing {historyData.length} of{" "}
                {pagination?.totalItems || historyData.length} records
              </p>
        ...
        <section className="rounded-xl border border-rose-500/20 bg-black/20 p-4 text-xs text-foreground/70">
          <div className="flex items-center gap-2">
            ...
            <p>
              This page intentionally shows only analysis metadata and usage
              data, not uploaded resume files.
            </p>
          </div>
        </section>
      </main>
